...
const toLastNames = people => {
  ...
  people.map((item) => {
    ...
    arrayOfPeople.push(item.firstName+' '+item.lastName);
  });
...
const addValues = (arr) => {
  let oldValues = arr.reduce((accumulator, values, index) => {
    let newValues = accumulator + values;
    return newValues;
  }, 0);
  return oldValues;
};
...
const addPurchases = (arr) => {
  let totalPurchased = arr.reduce((accumulator, val) => {
    accumulator = accumulator + val.purchasePrice;
    return accumulator;
...
const countNumberOfElements = (arr) => {
  let indexNum = arr.reduce((accumulator, val, index) => {
    accumulator = index + 1;
    return accumulator;
...
const returnNames = (arr) => {
  let arrayOfNames = arr.reduce((accumulator, val, index) => {
...
------------------------------------------------------------------------------------------------ */
// i used https://stackoverflow.com/questions/55427185/reverse-string-in-javascript-using-reduce-method
const reversedString = (str) => {
  return str.split('').reduce((accumulator, val) => val + accumulator, '');
